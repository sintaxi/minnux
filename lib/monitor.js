 ...
 * Spawned as a detached child by `monitor-process.js`, this script:
 *
...
var argv = minimist(process.argv.slice(2), {
  string: ['cmd', 'logfile', 'pidfile', 'monpidfile', 'on-error', 'on-restart', 'prefix', 'cwd'],
  default: {
    sleep: 1000,
    attempts: Infinity
  }
...
function spawnChild() {
  ...
  var opts = { stdio: ['ignore', 'pipe', 'pipe'], cwd: cwd };
  var handled = false;
